          ...
          <div class="card-body">
            ...
            >
              <b-form-input
                ...
                v-model="$v.frmJob.title.$model"
                :state="$v.frmJob.title.$dirty ? !$v.frmJob.title.$error : null"
            ...
            >
              <b-form-textarea
                ...
                v-model="$v.frmJob.description.$model"
                :state="
                  $v.frmJob.description.$dirty
                    ? !$v.frmJob.description.$error
                    : null
                "
              ...
              <b-form-invalid-feedback id="description-feedback">
                <span v-if="!$v.frmJob.description.required"
            ...
            >
              <b-form-textarea
                ...
                v-model="$v.frmJob.roles.$model"
                :state="$v.frmJob.roles.$dirty ? !$v.frmJob.roles.$error : null"
            ...
            >
              <b-form-input
                ...
                v-model="$v.frmJob.position.$model"
                :state="
                  $v.frmJob.position.$dirty ? !$v.frmJob.position.$error : null
                "
                aria-describedby="position-feedback"
              ></b-form-input>

              <b-form-invalid-feedback id="position-feedback">
                <span v-if="!$v.frmJob.position.required"
            ...
            >
              <b-form-textarea
                ...
                v-model="$v.frmJob.address.$model"
                :state="
                  $v.frmJob.address.$dirty ? !$v.frmJob.address.$error : null
                "
            ...
            <b-form-group
              id="number_of_vacancy-group"
              label="No. of Vacancy:"
              label-for="No. of Vacancy:"
              description=" "
            >
              <b-form-input
                ...
                v-model="$v.frmJob.number_of_vacancy.$model"
                :state="
                  $v.frmJob.number_of_vacancy.$dirty
                    ? !$v.frmJob.number_of_vacancy.$error
                    : null
                "
                aria-describedby="number_of_vacancy-feedback"
              ></b-form-input>

              <b-form-invalid-feedback id="number_of_vacancy-feedback">
                <span v-if="!$v.frmJob.number_of_vacancy.required"
                  >No. of Vacancy Required</span
                >
              </b-form-invalid-feedback>
            </b-form-group>
            <b-form-group
            ...
            >
              <b-form-input
                ...
                v-model="$v.frmJob.experience.$model"
                :state="
                  $v.frmJob.experience.$dirty
                    ? !$v.frmJob.experience.$error
                    : null
                "
              ...
              <b-form-invalid-feedback id="experience-feedback">
                <span v-if="!$v.frmJob.experience.required"
            ...
            >
              <b-form-input
                ...
                v-model="$v.frmJob.last_date.$model"
                :state="
                  $v.frmJob.last_date.$dirty
                    ? !$v.frmJob.last_date.$error
                    : null
                "
                aria-describedby="last_date-feedback"
              ></b-form-input>
...
export default {
  ...
  data() {
    return {
      ...
      company: [{ value: null, text: "Select Company" }],
  ...
  methods: {
    ...
    async getAllCategories() {
      try {
        this.categories = (
          await CategoryListingService.getAllCategories()
        ).data;
