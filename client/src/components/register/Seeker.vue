          ...
          <div class="card-header text-left">Job Seeker Register</div>
            <div class="card-body">
              ...
              <b-form-group id="username-group" label="Name:" label-for="username" description="">
                <b-form-input id="username" type="text" required placeholder="Enter Name" v-model="$v.frmSeeker.username.$model" :state="$v.frmSeeker.username.$dirty ? !$v.frmSeeker.username.$error : null"
                  aria-describedby="username-feedback"></b-form-input>
                <b-form-invalid-feedback id="username-feedback">
                  User name is requirede and must be at least 3 characters.
    ...
    async register () {
      ...
      // Posts data
       try {
        ...
        const response= await userAuthenticationService.userRegister(this.frmSeeker)
