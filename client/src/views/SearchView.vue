        ...
        <div id="app" class="row text-left">
          ...
          <div class="col-lg-8">
            ...
            <div class="p-4 mb-8 bg-white">
              ...
              <h3 class="h5 text-black mb-3">
                <i class="fa fa-user" style="color: blue;">&nbsp;</i>Roles and
                Responsibilities
              </h3>
              <p>
                Consectetur provident est est rerum aut repellendus repudiandae
                in. Vero expedita et praesentium et qui. Aperiam odit magni
                veritatis nobis doloremque aliquid. .
              </p>
            </div>
            <div class="p-4 mb-8 bg-white">
              <h3 class="h5 text-black mb-3">
                <i class="fa fa-users" style="color: blue;">&nbsp;</i>Number of
                vacancy
              </h3>
            ...
            <div class="p-4 mb-8 bg-white">
              <h3 class="h5 text-black mb-3">
                <i class="fa fa-dollar" style="color: blue;">&nbsp;</i>Salary
              </h3>
              <p>{{ jobs.salary }}</p>
            </div>
          </div>
          <div class="col-md-4 p-4 site-section bg-light">
            ...
            <p>Last date to apply: {{ Date(jobs.last_date) }}</p>
            <p>
              <a
